...
import 'package:covid19app/api/casesDayPerDay.dart';
...
class testlastest_state extends StatefulWidget {
  @override
  _testlastest_state createState() => _testlastest_state();
}

class _testlastest_state extends State<testlastest_state> {
        ...
        slivers: <Widget>[
          ...
          SliverFillRemaining(
              ...
              child: Column(
                ...
                children: <Widget>[
                  FutureBuilder(
                    future: fetchCasesStateUSA(),
                    builder: (context,AsyncSnapshot<casesPerDay> snapshot) {
                      if (snapshot.hasData) {
                        var usaStateCases = snapshot.data;
                        return Container(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                         usaStateCases.state[0].toString(),
                                      ...
                                      child: Column(
                                        children: <Widget>[
                                          ...
                                          Container(
                                            ...
                                            child: Text(
                                               usaStateCases.state[1].toString(),
                                              style: TextStyle(
                                                  fontWeight: FontWeight.w700,
                                                  color: CupertinoColors.black),
                                            ),
                                      ...
                                      child: Column(
                                        children: <Widget>[
                                          ...
                                          Container(
                                            ...
                                            child: Text(
                                               usaStateCases.state[2].toString(),
                                              style: TextStyle(
                                                  fontWeight: FontWeight.w700,
                                                  color: CupertinoColors.black),
                                            ),
                                      ...
                                      child: Column(
                                        children: <Widget>[
                                          ...
                                          Container(
                                            ...
                                            child: Text(
                                              usaStateCases.state[4].toString(),
                                              style: TextStyle(
                                                  fontWeight: FontWeight.w700,
                                                  color: CupertinoColors.black),
                                            ),
                                      ...
                                      child: Column(
                                        children: <Widget>[
                                          ...
                                          Container(
                                            ...
                                            child: Text(
                                              usaStateCases.state[5].toString(),
                                              style: TextStyle(
                                                  fontWeight: FontWeight.w700,
                                                  color: CupertinoColors.black),
                                            ),
